...
Para el desarrollo de la aplicación se adopta la metodología RAD (Rapid Application Development / Desarrollo Rápido de Aplicaciones)~\cite{fauzi2023}, seleccionando y adaptando sus fases al contexto de un sistema de gestión nutricional con inteligencia artificial. RAD permite construir prototipos funcionales de forma iterativa e incremental con retroalimentación continua, reduciendo los tiempos de desarrollo mediante componentes
...
\begin{itemize}
  ...
  $\rightarrow$ backend $\rightarrow$ API Groq con Llama~3.3~\cite{grattafiori2024} $\rightarrow$
...
El sistema emplea el modelo de lenguaje de código abierto dentro de un pipeline de generación aumentada por recuperación~(RAG)~\cite{lewis2020,tokic2026},
